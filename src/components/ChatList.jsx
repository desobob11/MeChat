...
export default function ChatList() {
    return (
        <div className="w-96">
            ...
            <ul role="list" className="divide-y divide-gray-100 border-solid border-1 shadow-md rounded-xl h-96 overflow-auto">
                {people.map((person) => (
                    <li key={person.email} className="flex justify-between gap-x-6 p-5 border-solid border-b-1 ">
